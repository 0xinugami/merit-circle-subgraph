...
export class MeritCircleToken__checkpointsResultValue0Struct extends ethereum.Tuple {
...
export class MeritCircleToken extends ethereum.SmartContract {
  static bind(address: Address): MeritCircleToken {
    return new MeritCircleToken("MeritCircleToken", address);
  }
  ...
  checkpoints(
    account: Address,
    pos: BigInt
  ): MeritCircleToken__checkpointsResultValue0Struct {
    let result = super.call(
      "checkpoints",
    ...
    return changetype<MeritCircleToken__checkpointsResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_checkpoints(
    account: Address,
    pos: BigInt
  ): ethereum.CallResult<MeritCircleToken__checkpointsResultValue0Struct> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):((uint32,uint224))",
      [
    ...
    return ethereum.CallResult.fromValue(
      changetype<MeritCircleToken__checkpointsResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }
